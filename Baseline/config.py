...
exp_name = f"{model_arch_name.upper()}-cifar100"
...
if mode == "train":
    ...
    pretrained_model_weights_path = "./path/trainmodel/AlexNetpretrain.pth.tar"
...
if mode == "test":
    ...
    model_weights_path = "./path/testmodel/AlexNetmodel.pth.tar"
