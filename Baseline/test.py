...
from utils import load_state_dict, accuracy, Summary, AverageMeter, ProgressMeter, changeType
...
def main() -> None:
    ...
    alexnet_model.eval()
    precision="32float"#16,32,64:int,float

    # Load test dataloader
    test_prefetcher = load_dataset()
    test_prefetcher =changeType(test_prefetcher,precision)
